...
Hidden fields are specified with a seperate hash reference in the data structure. They take a subset of the same options as normal fields. The relevant options are name (which is mandatory), id, extra, and default.
